...
export const heroData = {
  ...
  subtitle:
    "Я Full-stack разработчик. Делаю быстрые, удобные и современные сайты и веб-приложения. Продумываю интерфейсы так, чтобы ими было приятно пользоваться. От структуры до анимаций. Пишу чистый код, который легко поддерживать и развивать.",
  subtitleSecondary:
    "Разрабатываю разные продукты: от сложных веб-сервисов до промо-сайтов и кастомных интерфейсов. Фокус - удобство, скорость и результат для бизнеса.",
