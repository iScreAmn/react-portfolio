...
const portfolioData = [
  ...
  },
  {
    ...
    imgSrc: baluCover,
    href: "https://balu-balkon.ru/",
    year: "2026",
    tags: ["Multi-page", "Commercial Design", "Responsive"],
    description:
      "Multi-page website for a company specializing in glazing, insulation, and turnkey renovation of balconies and loggias.",
    categoryRu: "Строительная компания",
    descriptionRu:
      "Многостраничный сайт компании, специализирующейся на остеклении, утеплении и комплексном ремонте балконов и лоджий под ключ.",
    gallery: [balu1, balu2, balu3, balu4],
  },
  {
    id: 6,
    slug: "lawfirm",
    ...
    year: "2024",
    tags: ["Multi-page", "i18n", "Corporate Design"],
    description:
      'Multi-page corporate website for the Georgian law firm "მართლმსაჯულება" / "Martlmsajuleba".',
  ...
  },
  {
    ...
    year: "2023",
    tags: ["Booking Functionality", "i18n", "Corporate Design"],
    description:
      "Multi-page business-card website for an apartment rental service.",
    categoryRu: "Аренда апартаментов",
    descriptionRu:
      "Многостраничный сайт-визитка сервиса аренды апартаментов.",
    gallery: [otn1, otn2, otn3, otn4],
  },
  {
    id: 5,
    slug: "askchef",
